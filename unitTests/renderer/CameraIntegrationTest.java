...
public class CameraIntegrationTest {
    ...
    public void cameraRaySphereIntegration() {
        Camera cam1 = new Camera.BuilderCamera(Point.ZERO, new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
    ...
    public void cameraRayPlaneIntegration() {
        Camera cam = new Camera.BuilderCamera(Point.ZERO, new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
    ...
    public void cameraRayTriangleIntegration() {
        Camera cam = new Camera.(Point., new Vector(0, 0, -1), new Vector(0, -1, 0))
                .build();
